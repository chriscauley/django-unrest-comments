...
riot.tag2('comment-form', '<form action="{opts.form_url}" method="POST" class="comment_form_wrapper" id="{opts.form_id}"> <div class="comment_form"> <md-help></md-help> <div class="{uR.config.form.field_class}"> <textarea cols="40" class="{uR.theme.input}" id="id_comment" name="comment" rows="10">{opts.comment}</textarea> <input id="id_content_type" name="content_type" type="hidden" riot-value="{opts.content_type}"> <input id="id_object_pk" name="object_pk" type="hidden" riot-value="{opts.object_pk}"> <input id="id_parent_pk" name="parent_pk" type="hidden" riot-value="{opts.parent_pk}"> <input id="id_comment_pk" name="comment_pk" type="hidden" riot-value="{opts.pk}"> <input type="submit" class="submit-post {uR.config.btn_success}" value="Post" onclick="{submit}"> <input type="submit" class="submit-post {uR.config.btn_cancel}" value="Cancel" onclick="{cancel}"> </fieldset> </div> </form>', '', '', function(opts) {
  var self = this;
